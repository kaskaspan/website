...
import { loginWithEmail, signUp, loginWithUsername, loginWithGoogle } from "@/lib/supabase/auth";
      ...
      <Card className="w-full max-w-md mx-4 p-8 bg-white/10 backdrop-blur-sm border border-white/20">
        ...
        <div className="space-y-4 mb-6">
          <Button
            ...
            className="w-full bg-white text-gray-900 hover:bg-gray-100 border border-gray-200 flex items-center justify-center gap-2"
            disabled={isLoading}
          >
